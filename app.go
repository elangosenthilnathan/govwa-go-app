...
import (
	...
	"bitbucket.org/ericroku/govwa-go-app/setting"
	"bitbucket.org/ericroku/govwa-go-app/setup"
	"bitbucket.org/ericroku/govwa-go-app/user"
	"bitbucket.org/ericroku/govwa-go-app/util"
	"bitbucket.org/ericroku/govwa-go-app/util/config"
	"bitbucket.org/ericroku/govwa-go-app/util/middleware"
	"bitbucket.org/ericroku/govwa-go-app/vulnerability/csa"
	"bitbucket.org/ericroku/govwa-go-app/vulnerability/idor"
	"bitbucket.org/ericroku/govwa-go-app/vulnerability/sqli"
	"bitbucket.org/ericroku/govwa-go-app/vulnerability/xss"
)
